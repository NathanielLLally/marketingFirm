...
create table email_content (id integer PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY, content text, content_md5 varchar(32) generated always as (md5(content)) stored unique);
