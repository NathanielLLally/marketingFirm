module "cs-folders-iam-0-computeinstanceAdminv1" {
  ...
  bindings = {
    "roles/compute.instanceAdmin.v1" = [
      "group:gcp-developers@grandstreet.group",
    ]
  }
}
...
module "cs-projects-iam-2-loggingviewer" {
  ...
  bindings = {
    "roles/logging.viewer" = [
      "group:gcp-logging-monitoring-viewers@grandstreet.group",
    ]
  }
}
...
module "cs-projects-iam-3-bigquerydataViewer" {
  ...
  bindings = {
    "roles/bigquery.dataViewer" = [
      "group:gcp-security-admins@grandstreet.group",
    ]
  }
}
...
module "cs-service-projects-iam-4-computeinstanceAdminv1" {
  ...
  projects = [
    module.cs-svc-prod1-svc-1zfa.project_id,
  ]
  bindings = {
    "roles/compute.instanceAdmin.v1" = [
...
module "cs-service-projects-iam-5-computeinstanceAdminv1" {
  ...
  projects = [
    module.cs-svc-prod2-svc-1zfa.project_id,
  ]
  bindings = {
    "roles/compute.instanceAdmin.v1" = [
...
module "cs-service-projects-iam-6-computeinstanceAdminv1" {
  ...
  projects = [
    module.cs-svc-nonprod1-svc-1zfa.project_id,
  ]
  bindings = {
    "roles/compute.instanceAdmin.v1" = [
...
module "cs-service-projects-iam-7-computeinstanceAdminv1" {
  ...
  projects = [
    module.cs-svc-nonprod2-svc-1zfa.project_id,
  ]
  bindings = {
    "roles/compute.instanceAdmin.v1" = [
