module "cs-svc-prod1-svc-1zfa" {
  source  = "terraform-google-modules/project-factory/google//modules/svpc_service_project"
  version = "~> 16.0"

  name            = "prod1-service"
  project_id      = "prod1-svc-1zfa"
  org_id          = var.org_id
  ...
  shared_vpc_subnets = [
    try(module.cs-vpc-prod-shared.subnets["us-west1/subnet-prod-1"].self_link, ""),
  ]
...
module "cs-svc-prod2-svc-1zfa" {
  source  = "terraform-google-modules/project-factory/google//modules/svpc_service_project"
  version = "~> 16.0"

  name            = "prod2-service"
  project_id      = "prod2-svc-1zfa"
  org_id          = var.org_id
  billing_account = var.billing_account
  folder_id       = local.folder_map["Production"].id
  ...
  shared_vpc = module.cs-vpc-prod-shared.project_id
  shared_vpc_subnets = [
    try(module.cs-vpc-prod-shared.subnets["southamerica-west1/subnet-prod-2"].self_link, ""),
  ]
...
module "cs-svc-nonprod1-svc-1zfa" {
  source  = "terraform-google-modules/project-factory/google//modules/svpc_service_project"
  version = "~> 16.0"

  name            = "nonprod1-service"
  project_id      = "nonprod1-svc-1zfa"
  org_id          = var.org_id
  billing_account = var.billing_account
...
module "cs-svc-nonprod2-svc-1zfa" {
  source  = "terraform-google-modules/project-factory/google//modules/svpc_service_project"
  version = "~> 16.0"

  name            = "nonprod2-service"
  project_id      = "nonprod2-svc-1zfa"
  org_id          = var.org_id
  billing_account = var.billing_account
  folder_id       = local.folder_map["Non-Production"].id
